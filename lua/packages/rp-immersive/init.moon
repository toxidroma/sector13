...
class IMMERSIVE extends PLAYER
    ...
    GetViewOrigin: =>
        pos, ang = super!
        if @UseDynamicView and @Player\GetObserverMode! == OBS_MODE_NONE
            ent = @Player\GetBody!
...
hook.Add 'PlayerBindPress', 'fuck standard controls', (ply, bind, down) ->
    if down
        return true if find bind, fuckedoff for fuckedoff in *NO

hook.Add 'ScoreboardShow', 'fuck the scoreboard', ->
    gui.EnableScreenClicker true
    true

hook.Add 'ScoreboardHide', 'fuck the scoreboard', ->
